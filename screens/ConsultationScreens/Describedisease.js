        ...
        <View>
            ...
            <View style={{ marginHorizontal: 8, marginVertical: 8, height: 98 }}>
                ...
                <FlatList data={Department} renderItem={({ item, index }) =>
                    <TouchableOpacity style={styles.list} onPress={() => selectedfn(item)}>
                        {clicked == item.key ? <Text style={styles.text1}>{item.title}</Text>
            ...
            <View style={{ flexDirection: 'row', marginHorizontal: 10, justifyContent: 'space-between', alignItems: 'stretch' }}>
                <Image source={require('../../assets/AI.png')} style={{ marginRight: 60 }} />
                <FlatList
                    data={BodyPart}
                    renderItem={({ item }) =>
                        <TouchableOpacity style={{ flexDirection: 'row', marginBottom: 5, alignItems: 'center', height: 60 }}>
                            <View style={{ height: 38, width: 38, borderRadius: 38, backgroundColor: COLORS.green, justifyContent: 'center', alignItems: 'center', marginRight: 15 }}>
            ...
            <Button text='Describe Illiness'
                style={{ backgroundColor: COLORS.primary, marginTop: 25, padding: 5, height: 40, alignSelf: 'center' }}
